            ...
            <section id="home" class="bg-[#FEFCFB]">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        ...
                        <a href="#pricing" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium font-poppins text-center text-[#FA7436] rounded-lg border border-lg border-[#FA7436] hover:bg-[#FA7436] hover:text-white hover:drop-shadow-md hover:drop-shadow-[#FDDBCC]">
                            See Pricing
                        </a>
                    </div>
                </div>
