        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:gap-1 gap-4">
            <div className="bg-white md:rounded-l-xl p-6 md:h-3/4 md:my-16">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Lite</h3>
              <p className="text-gray-600 mb-4">Landing Page</p>
              <div className="flex items-baseline mb-6">
                <span className="text-5xl font-extrabold text-gray-900">$1000</span>
                <span className="text-gray-500 ml-1">/wk</span>
              </div>
              ...
              <button className="w-full bg-white text-orange-500 border border-orange-500 px-6 py-3 rounded-md shadow-sm hover:bg-orange-500 hover:text-white transition-colors duration-300">
                Select
              </button>
            </div>
            ...
            <div className="bg-white p-6 md:h-5/6 md:my-12">
              ...
              <p className="text-gray-600 mb-4">Websites and webapp</p>
              <div className="flex items-baseline mb-6">
            ...
            <div className="max-w-4xl mx-auto">
                <h1 className="text-4xl font-bold mb-4 text-[#3FDD78]">Pro</h1>
                <h2 className="text-2xl mb-8">AI Feature</h2>
                <p className="text-6xl font-bold mb-8">$3500<span className="text-2xl">/wk</span></p>
                ...
                <li>Data collection <span className="bg-[#FF97E8] text-[#222222] px-2 py-1 rounded-md ml-2">+$300/1,000 data</span></li>
                </ul>
                <button className="w-full text-white bg-[#FA7436] px-6 py-3 rounded-md shadow-sm hover:bg-orange-500 hover:text-white transition-colors duration-300">
                Select
              </button>
            </div>
            </div>
